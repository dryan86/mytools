...
function main(){
    if (app.documents.length > 0) 
    {
        ...
        // modify doc size
		var w = UnitValue( defaultSetting.canvasWidth, "px" );
		var h = UnitValue( defaultSetting.canvasHeight, "px" );
		myDocument.resizeCanvas( w, h, AnchorPosition.TOPLEFT );
...
function showDialog () {
	...
	var canvasGroup = dialog.add("panel", [0, 0, 180, 50], "Canvas Size");
	var canvasWidthText = canvasGroup.add("edittext", [10,10,60,30], defaultSetting.canvasWidth); 
	var canvasHeightText = canvasGroup.add("edittext", [80,10,130,30], defaultSetting.canvasHeight); 
	canvasWidthText.onChanging = function() {
        defaultSetting.canvasWidth = Math.round(canvasWidthText.text);
	};
	canvasHeightText.onChanging = function() {
        defaultSetting.canvasHeight = Math.round(canvasHeightText.text);
	};
